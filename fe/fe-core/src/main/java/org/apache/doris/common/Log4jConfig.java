...
public class Log4jConfig extends XmlConfiguration {
    ...
    private static String xmlConfTemplate = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
            ...
            + "    </Logger>\n"
            + "    <Logger name=\"io.grpc.netty.NettyClientHandler\" level=\"INFO\" additivity=\"false\">\n"
            + "      <AppenderRef ref=\"Auditfile\"/>\n"
            + "    </Logger>\n"
            + "    <Logger name=\"io.grpc.netty.NettyServerHandler\" level=\"INFO\" additivity=\"false\">\n"
            + "      <AppenderRef ref=\"Auditfile\"/>\n"
            + "    </Logger>\n"
            + "    <Logger name=\"io.grpc.netty.io.grpc.netty.NettyClientHandler\" level=\"INFO\" additivity=\"false\">\n"
            + "      <AppenderRef ref=\"Auditfile\"/>\n"
            + "    </Logger>\n"
            + "    <Logger name=\"io.grpc.netty.io.grpc.netty.NettyServerHandler\" level=\"INFO\" additivity=\"false\">\n"
            + "      <AppenderRef ref=\"Auditfile\"/>\n"
            + "    </Logger>\n"
